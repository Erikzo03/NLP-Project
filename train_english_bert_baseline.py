...
def parse_args():
    parser = argparse.ArgumentParser(description="English-only BERT baseline for EWT NER")
    parser.add_argument("--train_file", default="Datasets/en_ewt-ud-train.iob2")
    parser.add_argument("--dev_file", default="Datasets/en_ewt-ud-dev.iob2")
    parser.add_argument("--test_file", default="Datasets/en_ewt-ud-test-masked.iob2")
...
def main():
    ...
    print("Evaluate dev file with: python span_f1.py Datasets/en_ewt-ud-dev.iob2 <dev_predictions.iob2>")
