...
\textbf{MISC F1 = 0.0.} The Universal NER Danish file stores MISC annotations in a secondary column (e.g.\ \texttt{B-MISC\#O}) not read by training or evaluation code---a data-format artifact, not a modeling failure (32 dev and 44 test instances affected).
