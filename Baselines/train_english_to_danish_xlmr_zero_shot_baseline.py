    ...
    main(
        {
            ...
            "output_dir": os.path.join(BASE_DIR, "outputs/english_to_danish_xlmr_zero_shot"),
            "label_report_path": os.path.join(BASE_DIR, "Baselines/reports/english_to_danish_labels_xlmr.json"),
        }
    )
