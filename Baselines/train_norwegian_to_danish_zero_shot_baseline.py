    ...
    main(
        {
            ...
            "output_dir": os.path.join(BASE_DIR, "outputs/norwegian_to_danish_mbert_zero_shot"),
            "label_report_path": os.path.join(BASE_DIR, "Baselines/reports/norwegian_to_danish_labels_mbert.json"),
        }
    )
