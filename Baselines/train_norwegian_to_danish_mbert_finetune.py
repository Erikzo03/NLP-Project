    ...
    main(
        {
            ...
            "model_name": os.path.join(BASE_DIR, "outputs/norwegian_to_danish_mbert_zero_shot/checkpoint-7088"),
            "output_dir": os.path.join(BASE_DIR, "outputs/norwegian_to_danish_mbert_finetuned_danish"),
            "label_report_path": os.path.join(
                BASE_DIR, "Baselines/reports/norwegian_to_danish_mbert_finetune_labels.json"
            ),
        }
    )
